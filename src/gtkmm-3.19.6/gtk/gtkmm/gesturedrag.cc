...
{
  using namespace Gtk;
  typedef sigc::slot< void,double,double > SlotType;
...
Glib::SignalProxy2< void,double,double > GestureDrag::signal_drag_begin()
{
  return Glib::SignalProxy2< void,double,double >(this, &GestureDrag_signal_drag_begin_info);
}


Glib::SignalProxy2< void,double,double > GestureDrag::signal_drag_update()
{
  return Glib::SignalProxy2< void,double,double >(this, &GestureDrag_signal_drag_update_info);
}


Glib::SignalProxy2< void,double,double > GestureDrag::signal_drag_end()
{
  return Glib::SignalProxy2< void,double,double >(this, &GestureDrag_signal_drag_end_info);
}

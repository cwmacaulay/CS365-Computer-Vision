...
Glib::SignalProxy2< void,const Glib::RefPtr<const CssSection>&,const Glib::Error& > CssProvider::signal_parsing_error()
{
  return Glib::SignalProxy2< void,const Glib::RefPtr<const CssSection>&,const Glib::Error& >(this, &CssProvider_signal_parsing_error_info);
}

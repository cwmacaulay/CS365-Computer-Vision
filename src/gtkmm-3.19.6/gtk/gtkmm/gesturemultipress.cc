...
{
  using namespace Gtk;
  typedef sigc::slot< void,int,double,double > SlotType;
...
Glib::SignalProxy3< void,int,double,double > GestureMultiPress::signal_pressed()
{
  return Glib::SignalProxy3< void,int,double,double >(this, &GestureMultiPress_signal_pressed_info);
}


Glib::SignalProxy3< void,int,double,double > GestureMultiPress::signal_released()
{
  return Glib::SignalProxy3< void,int,double,double >(this, &GestureMultiPress_signal_released_info);
}


Glib::SignalProxy0< void > GestureMultiPress::signal_stopped()
{
  return Glib::SignalProxy0< void >(this, &GestureMultiPress_signal_stopped_info);
}

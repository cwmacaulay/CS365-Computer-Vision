...
public:
   ...
   * model is unset.
   * 
   * @return A Gtk::TreeModel, or <tt>nullptr</tt> if
  ...
  */
   ...
   * 
   * @param path A Gtk::TreePath.
   * @param focus_column A Gtk::TreeViewColumn, or <tt>nullptr</tt>.
   * @param focus_cell A Gtk::CellRenderer, or <tt>nullptr</tt>.
   * @param start_editing <tt>true</tt> if the specified cell should start being edited.
   */
...
/* Layout information */
   ...
   * 
   * @return A Gdk::Window, or <tt>nullptr</tt> when @a tree_view
...
/* Interactive search */
   ...
   * @newin{2,10}
   * 
   * @param entry The entry the interactive search code of @a tree_view should use or <tt>nullptr</tt>.
   */
   ...
   * 
   * @param tooltip A Gtk::Tooltip.
   * @param path A Gtk::TreePath or <tt>nullptr</tt>.
   * @param column A Gtk::TreeViewColumn or <tt>nullptr</tt>.

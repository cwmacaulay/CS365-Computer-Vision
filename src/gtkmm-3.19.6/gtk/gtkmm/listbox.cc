...
{
  using namespace Gtk;
  typedef sigc::slot< void,ListBoxRow* > SlotType;
...
Glib::SignalProxy1< void,ListBoxRow* > ListBox::signal_row_selected()
{
  return Glib::SignalProxy1< void,ListBoxRow* >(this, &ListBox_signal_row_selected_info);
}


Glib::SignalProxy1< void,ListBoxRow* > ListBox::signal_row_activated()
{
  return Glib::SignalProxy1< void,ListBoxRow* >(this, &ListBox_signal_row_activated_info);
}


Glib::SignalProxy0< void > ListBox::signal_selected_rows_changed()
{
  return Glib::SignalProxy0< void >(this, &ListBox_signal_selected_rows_changed_info);
}

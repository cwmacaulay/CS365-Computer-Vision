...
public:
   ...
   * @newin{3,2}
   * 
   * @param text A string to be displayed when @a entry is empty an unfocused, or <tt>nullptr</tt>.
   */
  ...
  /** Retrieves the Icon used for the icon, or <tt>nullptr</tt> if there is
   * no icon or if the icon was set by some other method (e.g., by
   ...
   * 
   * @param icon_pos Icon position.
   * @return A Icon, or <tt>nullptr</tt> if no icon is set
   ...
   * 
   * @param icon_pos The icon position.
   * @return The tooltip text, or <tt>nullptr</tt>. Free the returned

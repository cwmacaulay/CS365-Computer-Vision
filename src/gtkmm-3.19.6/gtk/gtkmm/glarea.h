...
/** If set to <tt>true</tt> the widget will allocate and enable a stencil buffer for the
  ...
  Glib::SignalProxy0< Glib::RefPtr<Gdk::GLContext> > signal_create_context();
  ...
  Glib::SignalProxy1< bool,const Glib::RefPtr<Gdk::GLContext>& > signal_render();
  ...
  Glib::SignalProxy2< void,int,int > signal_resize();

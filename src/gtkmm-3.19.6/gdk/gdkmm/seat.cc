...
{
  using namespace Gdk;
  typedef sigc::slot< void,const Glib::RefPtr<Device>& > SlotType;
...
Glib::SignalProxy1< void,const Glib::RefPtr<Device>& > Seat::signal_device_added()
{
  return Glib::SignalProxy1< void,const Glib::RefPtr<Device>& >(this, &Seat_signal_device_added_info);
}


Glib::SignalProxy1< void,const Glib::RefPtr<Device>& > Seat::signal_device_removed()
{
  return Glib::SignalProxy1< void,const Glib::RefPtr<Device>& >(this, &Seat_signal_device_removed_info);
}

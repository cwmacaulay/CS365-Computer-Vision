...
public:
  ...
  */
   ...
   * <tt>nullptr</tt> if retrieving the selection data failed. (This could
   ...
   * @newin{2,14}
   * 
   * @return A newly-allocated <tt>nullptr</tt>-terminated array of strings which must
   * be freed with Glib::strfreev(), or <tt>nullptr</tt> if retrieving the

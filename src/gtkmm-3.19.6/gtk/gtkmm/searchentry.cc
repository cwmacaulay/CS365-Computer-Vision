...
Glib::SignalProxy0< void > SearchEntry::signal_search_changed()
{
  return Glib::SignalProxy0< void >(this, &SearchEntry_signal_search_changed_info);
}


Glib::SignalProxy0< void > SearchEntry::signal_next_match()
{
  return Glib::SignalProxy0< void >(this, &SearchEntry_signal_next_match_info);
}


Glib::SignalProxy0< void > SearchEntry::signal_previous_match()
{
  return Glib::SignalProxy0< void >(this, &SearchEntry_signal_previous_match_info);
}


Glib::SignalProxy0< void > SearchEntry::signal_stop_search()
{
  return Glib::SignalProxy0< void >(this, &SearchEntry_signal_stop_search_info);
}

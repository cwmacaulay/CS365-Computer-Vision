...
{
  using namespace Gtk;
  typedef sigc::slot< void,Gtk::StateFlags > SlotType;
...
{
  using namespace Gtk;
  typedef sigc::slot< bool,const ::Cairo::RefPtr< ::Cairo::Context>& > SlotType;
...
{
  using namespace Gtk;
  typedef sigc::slot< void,const ::Cairo::RefPtr< ::Cairo::Context>& > SlotType;
...
{
  using namespace Gtk;
  typedef sigc::slot< bool,GdkEventTouch* > SlotType;
...
{
  using namespace Gtk;
  typedef sigc::slot< void,GdkEventTouch* > SlotType;
...
Glib::SignalProxy1< void,Gtk::StateFlags > Widget::signal_state_flags_changed()
{
  return Glib::SignalProxy1< void,Gtk::StateFlags >(this, &Widget_signal_state_flags_changed_info);
}
...
Glib::SignalProxy0< void > Widget::signal_style_updated()
{
  return Glib::SignalProxy0< void >(this, &Widget_signal_style_updated_info);
}
...
Glib::SignalProxy1< bool,const ::Cairo::RefPtr< ::Cairo::Context>& > Widget::signal_draw()
{
  return Glib::SignalProxy1< bool,const ::Cairo::RefPtr< ::Cairo::Context>& >(this, &Widget_signal_draw_info);
}
...
Glib::SignalProxy1< bool,GdkEventTouch* > Widget::signal_touch_event()
{
  return Glib::SignalProxy1< bool,GdkEventTouch* >(this, &Widget_signal_touch_event_info);
}

...
public:
   ...
   * or <tt>nullptr</tt> to disable the button. If Gtk::MenuButton::property_menu_model() or
   * Gtk::MenuButton::property_popover() are set, they will be set to <tt>nullptr</tt>.
   * 
   * @newin{3,6}
   * 
   ...
   * clicked, or <tt>nullptr</tt> to disable the button. If Gtk::MenuButton::property_menu_model()
   * or Gtk::MenuButton::property_popup() are set, they will be set to <tt>nullptr</tt>.
   * 
   * @newin{3,12}
   * 
   ...
   * or <tt>nullptr</tt> to disable the button.
   * 
   ...
   * @newin{3,6}
   * 
   * @return A MenuModel or <tt>nullptr</tt>.
   */

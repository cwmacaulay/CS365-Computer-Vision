...
Glib::SignalProxy2< void,double,double > GestureRotate::signal_angle_changed()
{
  return Glib::SignalProxy2< void,double,double >(this, &GestureRotate_signal_angle_changed_info);
}

...
{
  using namespace Gtk;
  typedef sigc::slot< Glib::RefPtr<Gdk::GLContext> > SlotType;
...
{
  using namespace Gtk;
  typedef sigc::slot< bool,const Glib::RefPtr<Gdk::GLContext>& > SlotType;
...
{
  using namespace Gtk;
  typedef sigc::slot< void,const Glib::RefPtr<Gdk::GLContext>& > SlotType;
  ...
  if(obj_base && obj_base->is_derived_())
  {
    ...
    if(obj) // This can be NULL during destruction.
    {
      try // Trap C++ exceptions which would normally be lost because this is a C callback.
      {
        ...
        return Glib::unwrap(obj->on_create_context());
      }
      catch(...)
      {
        Glib::exception_handlers_invoke();
...
Glib::SignalProxy0< Glib::RefPtr<Gdk::GLContext> > GLArea::signal_create_context()
{
  return Glib::SignalProxy0< Glib::RefPtr<Gdk::GLContext> >(this, &GLArea_signal_create_context_info);
}


Glib::SignalProxy1< bool,const Glib::RefPtr<Gdk::GLContext>& > GLArea::signal_render()
{
  return Glib::SignalProxy1< bool,const Glib::RefPtr<Gdk::GLContext>& >(this, &GLArea_signal_render_info);
}


Glib::SignalProxy2< void,int,int > GLArea::signal_resize()
{
  return Glib::SignalProxy2< void,int,int >(this, &GLArea_signal_resize_info);
}
...
Glib::RefPtr<Gdk::GLContext> Gtk::GLArea::on_create_context()
{
  ...
  typedef Glib::RefPtr<Gdk::GLContext> RType;
  return RType();
}

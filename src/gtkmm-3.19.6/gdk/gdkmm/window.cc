...
{
  return ::Cairo::RefPtr< ::Cairo::Surface>(new ::Cairo::Surface(gdk_window_create_similar_image_surface(gobj(), (cairo_format_t)(format), width, height, scale), false /* take reference */));
}

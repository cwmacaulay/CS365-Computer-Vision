...
{
  using namespace Gtk;
  typedef sigc::slot< Glib::ustring,const TreeModel::Path& > SlotType;
...
Glib::SignalProxy1< Glib::ustring,const TreeModel::Path& > ComboBox::signal_format_entry_text()
{
  return Glib::SignalProxy1< Glib::ustring,const TreeModel::Path& >(this, &ComboBox_signal_format_entry_text_info);
}

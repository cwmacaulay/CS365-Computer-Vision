...
class IconSource
{
  ...
  IconSource(IconSource&& other) noexcept;
  IconSource& operator=(IconSource&& other) noexcept;

  ~IconSource() noexcept;

  void swap(IconSource& other) noexcept;
...
public:
  ...
  /** Retrieves the source filename, or <tt>nullptr</tt> if none is set. The
  ...
  /** Retrieves the source pixbuf, or <tt>nullptr</tt> if none is set.
  ...
  /** Retrieves the source icon name, or <tt>nullptr</tt> if none is set. The
 ...
 */
inline void swap(IconSource& lhs, IconSource& rhs) noexcept
  { lhs.swap(rhs); }

...
{
  using namespace Gtk;
  typedef sigc::slot< void,Widget*,const Glib::RefPtr<PageSetup>&,const Glib::RefPtr<PrintSettings>& > SlotType;
...
Glib::SignalProxy3< void,Widget*,const Glib::RefPtr<PageSetup>&,const Glib::RefPtr<PrintSettings>& > PrintOperation::signal_update_custom_widget()
{
  return Glib::SignalProxy3< void,Widget*,const Glib::RefPtr<PageSetup>&,const Glib::RefPtr<PrintSettings>& >(this, &PrintOperation_signal_update_custom_widget_info);
}

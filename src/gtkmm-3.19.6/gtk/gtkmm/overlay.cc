...
{
  using namespace Gtk;
  typedef sigc::slot< bool,Gtk::Widget*,Gdk::Rectangle& > SlotType;
...
{
  using namespace Gtk;
  typedef sigc::slot< void,Gtk::Widget*,Gdk::Rectangle& > SlotType;
...
Glib::SignalProxy2< bool,Gtk::Widget*,Gdk::Rectangle& > Overlay::signal_get_child_position()
{
  return Glib::SignalProxy2< bool,Gtk::Widget*,Gdk::Rectangle& >(this, &Overlay_signal_get_child_position_info);
}

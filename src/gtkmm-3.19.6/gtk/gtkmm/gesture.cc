...
{
  using namespace Gtk;
  typedef sigc::slot< void,GdkEventSequence* > SlotType;
...
{
  using namespace Gtk;
  typedef sigc::slot< void,GdkEventSequence*,EventSequenceState > SlotType;
...
Glib::SignalProxy1< void,GdkEventSequence* > Gesture::signal_begin()
{
  return Glib::SignalProxy1< void,GdkEventSequence* >(this, &Gesture_signal_begin_info);
}


Glib::SignalProxy1< void,GdkEventSequence* > Gesture::signal_end()
{
  return Glib::SignalProxy1< void,GdkEventSequence* >(this, &Gesture_signal_end_info);
}


Glib::SignalProxy1< void,GdkEventSequence* > Gesture::signal_update()
{
  return Glib::SignalProxy1< void,GdkEventSequence* >(this, &Gesture_signal_update_info);
}


Glib::SignalProxy1< void,GdkEventSequence* > Gesture::signal_cancel()
{
  return Glib::SignalProxy1< void,GdkEventSequence* >(this, &Gesture_signal_cancel_info);
}


Glib::SignalProxy2< void,GdkEventSequence*,EventSequenceState > Gesture::signal_sequence_state_changed()
{
  return Glib::SignalProxy2< void,GdkEventSequence*,EventSequenceState >(this, &Gesture_signal_sequence_state_changed_info);
}

...
{
  using namespace Gdk;
  typedef sigc::slot< void,const Glib::RefPtr<Seat>& > SlotType;
...
Glib::SignalProxy1< void,const Glib::RefPtr<Seat>& > Display::signal_seat_added()
{
  return Glib::SignalProxy1< void,const Glib::RefPtr<Seat>& >(this, &Display_signal_seat_added_info);
}


Glib::SignalProxy1< void,const Glib::RefPtr<Seat>& > Display::signal_seat_removed()
{
  return Glib::SignalProxy1< void,const Glib::RefPtr<Seat>& >(this, &Display_signal_seat_removed_info);
}

...
public:
   ...
   * @newin{3,4}
   * 
   * @param app_menu A MenuModel, or <tt>nullptr</tt>.
   */
   ...
   * @newin{3,4}
   * 
   * @param menubar A MenuModel, or <tt>nullptr</tt>.
   */
   ...
   * a <tt>nullptr</tt>-terminated array. Free with Glib::strfreev() when no longer needed.
   */
